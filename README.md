...
Het KVK-nummer (85994367) is inmiddels overal ingevuld, en het veld "Bereikbaarheid" op de
contactpagina is verwijderd.
...
`privacyverklaring.html` bevat een conceptversie. Dit is
...
- Controleer of `[UWDOMEIN]` is ingevuld zodra het domein bekend is.
